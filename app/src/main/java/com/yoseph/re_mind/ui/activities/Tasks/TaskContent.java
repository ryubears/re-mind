package com.yoseph.re_mind.ui.activities.Tasks;
...
public class TaskContent {
    ...
    private static TaskItem createDummyItem(int position) {
    ...
    public static class TaskItem {
        ...
        public TaskItem(String id, String title, String details) {
            this.id = id;
            this.title = title;
